...
exports.LIVESTOCK_DISPLAY_NAMES = exports.CROP_DISPLAY_NAMES = exports.LIVESTOCK_THRESHOLDS = exports.CROP_THRESHOLDS = void 0;
exports.normalizeType = normalizeType;
exports.getCropThreshold = getCropThreshold;
exports.getLivestockThreshold = getLivestockThreshold;
exports.isInRange = isInRange;
// 10 CROP TYPES WITH CRITICAL TRACKING FEATURES
exports.CROP_THRESHOLDS = {
    wheat: {
...
function getCropThreshold(cropType) {
    return exports.CROP_THRESHOLDS[normalizeType(cropType)];
}
// Get livestock threshold by type
function getLivestockThreshold(animalType) {
    return exports.LIVESTOCK_THRESHOLDS[normalizeType(animalType)];
}
...
exports.LIVESTOCK_DISPLAY_NAMES = {
    cow: "İnek",
    sheep: "Koyun",
    goat: "Keçi",
    chicken: "Tavuk",
